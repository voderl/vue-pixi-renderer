...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vueConfig'), require('pixi.js-legacy')) :
  typeof define === 'function' && define.amd ? define(['vueConfig', 'pixi.js-legacy'], factory) :
  (global = global || self, global.Vue = factory(global.vueConfig, global.PIXI));
}(this, function (vueConfig, pixi_jsLegacy) { 'use strict';
  ...
  var isHTMLTag = makeMap(
    Object.keys(vueConfig.renderList).join(",")
    // "," +
  ...
  var updateValue = function (textNode) {
    var node = textNode.parent;
    if (!node) { return; }
    var data = vueConfig.attrList.get(node.tagName);
  ...
  function createElement$1(tagName, vnode) {
    ...
    var node = list[tagName](vnode, getValue(vnode));
  ...
  function updateAttrs(oldVnode, vnode) {
    ...
    var elm = vnode.elm;
    // data里面是一些属性的设置问题，
    var data = vueConfig.attrList.get(vnode.tag);
  ...
  function setInteractive(node, value) {
    ...
    if (value !== undefined) { node.interactive = value; }
      ...
      var shouldInteractiveChildren = false;
  ...
  function add$1(
    ...
    setInteractive(target$1, true);
    if (typeof handler === "function") {
      target$1.on(name, handler);
    } else if (typeof handler === "object" && handler.type === "once") {
      target$1.once(name, handler.fn);
    }
  }
  ...
  function updateStyle(oldVnode, vnode) {
    ...
    if (!vueConfig.styleList.types[vnode.tag]) { return; }
    if (
    ...
    var handle = vueConfig.styleList.get(vnode.tag);
    var dirty = false;
